...
<description>
   ...
   <de>Zusätzliche Symbole zum Anpassen des Startmenüs (antechdesigns collection)</de>
   <el>Πρόσθετα εικονίδια για την προσαρμογή του κουμπιού μενού εκκίνησης (συλλογή antechdesigns)</el>
   <en>extra icons for customizing the start menu button (antechdesigns collection)</en>
   <es>Iconos adicionales para personalizar el botón de menú inicio (colección antechdesigns)</es>
   ...
   <fi>lisäkuvakkeita mukauttaaksesi käynnistä-valikon painiketta (antechdesigns-kokoelma)</fi>
   ...
   <hi>आरंभ मेन्यू बटन के अनुकूलन हेतु अतिरिक्त आइकन (antechdesigns संग्रह)</hi>
   ...
   <nb>ekstra ikoner for å tilpasse startmeny-knappen (antechdesigns' samling)</nb>
   ...
   <pt_BR>Ícones extras para personalização do botão do menu Iniciar (coleção do usuário ‘antechdesigns’)</pt_BR>
   <pt>Ícones extra para personalização do botão do menu Iniciar (colecção do utilizador 'antechdesigns')</pt>
   <ro>extra icons for customizing the start menu button (antechdesigns collection)</ro>
   <ru>Дополнительные значки для настройки кнопки пуск (коллекция antechdesigns)</ru>
   ...
   <sq>ikona ekstra për përshtatje të butonave të menusë së nisjeve (koleksioni antechdesigns)</sq>
   ...
   <tr>başlat menüsü düğmelerini özelleştirmek için fazladan simgeler (antechdesigns koleksiyonu)</tr>
