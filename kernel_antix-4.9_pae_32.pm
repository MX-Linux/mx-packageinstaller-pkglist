...
<description>
   ...
   <ca>antiX 4.9.189 kernel, 32 bit pae</ca>
   ...
   <es>antiX 4.9.189 kernel, 32 bit pae</es>
   ...
   <fr>Noyau antiX 4.9.189, 32 bit pae</fr>
   ...
   <it>Kernel antiX 4.9.189, 32 bit pae</it>
   ...
   <pt>antiX 4.9.189 kernel, 32 bit pae</pt>
   <ro>antiX 4.9.189 kernel, 32 bit pae</ro>
   <ru>antiX ядро 4.9.189, 32 bit pae</ru>
   ...
   <sv>antiX 4.9.189 kernel, 32 bit pae</sv>
