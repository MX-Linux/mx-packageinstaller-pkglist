...
<description>
   ...
   <pt>antiX 4.9.126 kernel, 32 bit pae</pt>
   <ro>antiX 4.9.126 kernel, 32 bit pae</ro>
   <ru>antiX 4.9.126 kernel, 32 bit pae</ru>
   <sk>antiX 4.9.126 kernel, 32 bit pae</sk>
   <sv>antiX 4.9.126 kernel, 32 bit pae</sv>
