...
<description>
   ...
   <ca>fluxbox - after installation use mx-flux in menu to finish</ca>
   ...
   <de>fluxbox - after installation use mx-flux in menu to finish</de>
   ...
   <es>fluxbox - after installation use mx-flux in menu to finish</es>
   ...
   <ru>fluxbox - after installation use mx-flux in menu to finish</ru>
   <sk>fluxbox - after installation use mx-flux in menu to finish</sk>
   <sl>fluxbox - after installation use mx-flux in menu to finish</sl>
   ...
   <sv>fluxbox - after installation use mx-flux in menu to finish</sv>
