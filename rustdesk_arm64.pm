...
wget https://github.com/rustdesk/rustdesk/releases/download/$version/rustdesk-$version-aarch64.deb -O /tmp/rustdesk-$version-aarch64.deb; apt-get install /tmp/rustdesk-$version-aarch64.deb; rm /tmp/rustdesk-$version-aarch64.deb
</preinstall>
