...
<description>
   ...
   <ar>fast and simple image viewer</ar>
   <bg>fast and simple image viewer</bg>
   <bn>fast and simple image viewer</bn>
   ...
   <uk>швидкий та простий переглядач зображень</uk>
   <vi>fast and simple image viewer</vi>
   <zh_CN>fast and simple image viewer</zh_CN>
