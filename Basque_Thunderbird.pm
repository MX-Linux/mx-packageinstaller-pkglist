...
<description>
   ...
   <bn>Basque localisation of Thunderbird</bn>
   ...
   <el>Βασκικά για το Thunderbird</el>
   ...
   <nb>Baskisk lokaltilpassing av Thunderbird</nb>
   <nl>Baskische lokalisatie van Thunderbird</nl>
   <pl>Baskijska lokalizacja Thunderbirda</pl>
   <pt_BR>Basco Localização para o Thunderbird</pt_BR>
   <pt>Basco Localização para Thunderbird</pt>
   <ro>Basque localisation of Thunderbird</ro>
   <ru>Баскский перевод для Thunderbird</ru>
   <sk>Basque lokalizácia pre Thunderbird</sk>
   <sl>Baskovske krajevne nastavitve za Thunderbird</sl>
   <sq>Përkthimi i Thunderbird-it në baskisht</sq>
   ...
   <vi>Basque localisation of Thunderbird</vi>
