...
echo "deb https://mega.nz/linux/repo/Debian_13/ ./">/etc/apt/sources.list.d/mxpitemp.list
curl -sS https://mega.nz/linux/repo/Debian_13/Release.key | gpg --dearmor --yes -o /etc/apt/trusted.gpg.d/megasync.gpg
apt-get update
</preinstall>
