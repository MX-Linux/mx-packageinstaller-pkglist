...
<description>
   ...
   <ca>A simple way to use remote resources via an ssh encypted connection</ca>
   <cs>A simple way to use remote resources via an ssh encypted connection</cs>
   <da>A simple way to use remote resources via an ssh encypted connection</da>
   <de>A simple way to use remote resources via an ssh encypted connection</de>
   <el>A simple way to use remote resources via an ssh encypted connection</el>
   ...
   <fi>A simple way to use remote resources via an ssh encypted connection</fi>
   <fr>A simple way to use remote resources via an ssh encypted connection</fr>
   ...
   <it>A simple way to use remote resources via an ssh encypted connection</it>
   ...
   <nl>A simple way to use remote resources via an ssh encypted connection</nl>
   <pl>A simple way to use remote resources via an ssh encypted connection</pl>
   <pt_BR>A simple way to use remote resources via an ssh encypted connection</pt_BR>
   <pt>A simple way to use remote resources via an ssh encypted connection</pt>
   <ro>A simple way to use remote resources via an ssh encypted connection</ro>
   <ru>A simple way to use remote resources via an ssh encypted connection</ru>
   ...
   <sv>A simple way to use remote resources via an ssh encypted connection</sv>
