...
<description>
   ...
   <ar>MX 4.15 kernel, 32 bit PAE</ar>
   <bg>MX 4.15 kernel, 32 bit PAE</bg>
   <ca>Nucli de MX 4.15 32 bit, amb PAE</ca>
   <cs>MX 4.15 kernel, 32 bit PAE</cs>
   <da>MX 4.15 kerne, 32 bit PAE</da>
