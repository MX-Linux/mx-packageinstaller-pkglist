...
apt-get install linux-image-linux-image-7.1.7-1mx25ahs-siduction-amd64 linux-headers-7.1.7-1mx25ahs-siduction-amd64 ${DKMS_PKGS[*]}
</preinstall>
...
<postinstall>
rebuild_dkms_packages.sh linux-image-7.1.7-1mx25ahs-siduction-amd64
