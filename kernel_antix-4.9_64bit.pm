...
<description>
   ...
   <da>antiX 4.9.146 kernel Meltdown and Spectre patched, 64 bit</da>
   ...
   <fr>Noyau antiX 4.9.146 correctifs Meltdown et Spectre, 64 bit</fr>
   ...
   <it>antiX 4.9.146 kernel, con patch per Meltdown e Spectre, 64 bit</it>
   ...
   <pt_BR>antiX 4.9.146 kernel com correções para as falhas Meltdown e Spectre, 64 bit</pt_BR>
   <pt>Núcleo antiX 4.9.146 com correcções para as falhas Meltdown e Spectre, 64 bit</pt>
   <ro>antiX 4.9.146 kernel Meltdown and Spectre patched, 64 bit</ro>
   <ru>antiX ядро 4.9.146 с патчами от Meltdown и Spectre, 64 bit</ru>
   ...
   <sv>antiX 4.9.146 kärna Meltdown och Spectre fixad, 64 bit</sv>
