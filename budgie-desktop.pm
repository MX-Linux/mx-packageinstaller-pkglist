...
<description>
   ...
   <el>a lightweight desktop environment</el>
   <en>a lightweight desktop environment</en>
   <es>ambiente de escritorio liviano</es>
   <fi>a lightweight desktop environment</fi>
