...
<description>
   <am>graphical tool to diff and merge filesz</am>
   ...
   <el>Γραφικό εργαλείο για σύγκριση και συγχώνευση αρχείων</el>
   ...
   <nb>Grafisk «diff» og fletting av forskjeller mellom filer</nb>
...
<screenshot>https://screenshots.debian.net/screenshots/000/005/454/large.png</screenshot>
