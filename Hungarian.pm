...
<description>
   ...
   <bn>Hungarian Language Meta-Package</bn>
   ...
   <fil_PH>Hungarian Language Meta-Package</fil_PH>
   <fi>Unkarinkielinen metatieto-paketti</fi>
   <fr>Méta-paquet pour langue hongroise</fr>
   <he_IL>Hungarian Language Meta-Package</he_IL>
   <hi>हंगेरियाई भाषा मेटा-पैकेज</hi>
