...
<description>
   ...
   <nb>de klassiske skjermbeskytterne for X-tjenere</nb>
   ...
   <sq>ekrankursyesi klasik për shërbyes X</sq>
   <sr>the classic screensaver for X servers</sr>
   <sv>klassisk skärmsläckare för X server</sv>
   <tr>X sunucuları için klasik ekran koruyucu</tr>
