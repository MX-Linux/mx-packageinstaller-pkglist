...
<description>
   ...
   <de>Ein aktualisiertes/erfrischtes Faenza-ähnliches Symbolthema mit vielen Farbvarianten</de>
   <el>Ενημερωμένο/ανανεωμένο θέμα του Faenza με πολλές επιλογές χρωμάτων</el>
   <en>an updated/refreshed Faenza-ish icon theme with many colour choices</en>
   <es>Tema de iconos estilo Faenza reelaborados y con múltiples colores a elección.</es>
   ...
   <fi>päivitetty/virkistetty Faenza:n kaltainen kuvaketeema monine värivaihtoehtoineen</fi>
   ...
   <hi>अपडेट युक्त Faenza-समान आइकन थीम जिसमे अनेक रंगों हेतु विकल्प सम्मिलित हैं</hi>
   ...
   <ja>多くの色の選択肢を持つ、更新/リフレッシュされた Faenza 風のアイコンテーマ</ja>
   ...
   <nb>et oppdatert Faenza-aktig ikontema med mange fargevalg</nb>
   ...
   <pt_BR>Tema de ícones ao estilo Faenza atualizado/refrescado com muitas opções de cores</pt_BR>
   ...
   <sq>një temë ikonash në stil Faenza, e përditësuar/rifreskuar, me mjaft zgjedhje ngjyrash</sq>
   ...
   <tr>birçok renk seçeneğiyle güncellenmiş / yenilenmiş bir Faenza-ish simge teması</tr>
