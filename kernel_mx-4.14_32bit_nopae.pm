...
<description>
   ...
   <ar>MX 4.14 kernel, 32 bit no-pae</ar>
   <bg>MX 4.14 kernel, 32 bit no-pae</bg>
   <ca>Nucli de MX 4.14, 32 bit sense PAE</ca>
   <cs>MX 4.14 kernel, 32 bit no-pae</cs>
   <da>MX 4.14 kerne, 32 bit uden pae</da>
   <de>MX 4.14-Kernel, 32-Bit-No-PAE</de>
   <el>MX 4.14 πυρήνα, 32 bit no-pae</el>
   <en>MX 4.14 kernel, 32 bit no-pae</en>
   <es>MX 4.14 kernel, 32 bit no-pae</es>
   <et>MX 4.14 kernel, 32 bit no-pae</et>
   <eu>MX 4.14 kernel, 32 bit no-pae</eu>
   <fa>MX 4.14 kernel, 32 bit no-pae</fa>
   <fi>MX 4.14 kernel, 32 bit no-pae</fi>
   <fr>Noyau MX 4.14, 32 bit no-pae</fr>
   <he_IL>MX 4.14 kernel, 32 bit no-pae</he_IL>
   <hi>MX 4.14 kernel, 32 bit no-pae</hi>
   <hr>MX 4.14 kernel, 32 bit no-pae</hr>
   <hu>MX 4.14 kernel, 32 bit no-pae</hu>
   <id>MX 4.14 kernel, 32 bit no-pae</id>
   <is>MX 4.14 kernel, 32 bit no-pae</is>
   <it>MX 4.14 kernel, 32 bit no-pae</it>
   <ja_JP>MX 4.14 kernel, 32 bit no-pae</ja_JP>
   <ja>MX 4.14 kernel, 32 bit no-pae</ja>
   <kk>MX 4.14 kernel, 32 bit no-pae</kk>
   <ko>MX 4.14 kernel, 32 bit no-pae</ko>
   <lt>MX 4.14 kernel, 32 bit no-pae</lt>
   <mk>MX 4.14 kernel, 32 bit no-pae</mk>
   <nb>MX 4.14 kernel, 32 bit no-pae</nb>
   ...
   <ru>MX ядро 4.14, 32 bit no-PAE</ru>
   <sk>MX 4.14 kernel, 32 bit no-pae</sk>
   <sl>MX 4.14 kernel, 32 bit no-pae</sl>
   <sq>MX 4.14 kernel, 32 bit no-pae</sq>
   <sr>MX 4.14 kernel, 32 bit no-pae</sr>
   <sv>MX 4.14 kärna, 32 bit no-pae</sv>
   <tr>MX 4.14 kernel, 32 bit no-pae</tr>
   <uk>MX 4.14 kernel, 32 bit no-pae</uk>
   <zh_CN>MX 4.14 kernel, 32 bit no-pae</zh_CN>
