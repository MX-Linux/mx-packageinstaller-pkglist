...
<description>
   ...
   <da>antiX 4.18.7 kernel Meltdown and Spectre patched, 64 bit</da>
   <de>antiX 4.18.7 Kernel - Meltdown und Spectre gepatcht, 64 Bit</de>
   <el>antiX 4.18.7 πυρήνα Meltdown και Spectre patched, 64 bit</el>
   ...
   <fr>Noyau antiX 4.18.7 correctifs Meltdown et Spectre, 64 bit</fr>
   ...
   <is>antiX 4.18.7 kernel Meltdown and Spectre patched, 64 bit</is>
   <it>antiX 4.18.7 kernel, con patch per Meltdown e Spectre, 64 bit</it>
   ...
   <nl>antiX 4.18.7 kernel Meltdown en Spectre patched, 64 bit</nl>
   <pl>antiX 4.18.7 kernel Meltdown and Spectre patched, 64 bit</pl>
   <pt_BR>antiX 4.18.7 kernel com correções para as falhas Meltdown e Spectre, 64 bit</pt_BR>
   <pt>Núcleo antiX 4.18.7 com correcções para as falhas Meltdown e Spectre, 64 bit</pt>
   <ro>antiX 4.18.7 kernel Meltdown and Spectre patched, 64 bit</ro>
   <ru>antiX ядро 4.18.7 с патчами от Meltdown и Spectre, 64 bit</ru>
   <sk>antiX 4.18.7 kernel Meltdown and Spectre patched, 64 bit</sk>
   <sq>antiX 4.18.7 kernel Meltdown and Spectre patched, 64 bit</sq>
   <sv>antiX 4.18.7 kärna Meltdown och Spectre fixad, 64 bit</sv>
