...
<description>
   ...
   <pt>Núcleo (kernel) antiX 4.9.193, 32 bit pae</pt>
   <ro>antiX 4.9.193 kernel, 32 bit pae</ro>
   <ru>antiX 4.9.193 ядро, 32 bit PAE</ru>
   <sk>antiX 4.9.193 kernel, 32 bit pae</sk>
   <sl>antiX 4.9.193 jedro, 32 bitno pae</sl>
