...
<description>
   ...
   <ar>antiX 4.9.146 kernel, 32 bit no-pae</ar>
   <bg>antiX 4.9.146 kernel, 32 bit no-pae</bg>
   <ca>antiX 4.9.146 kernel, 32 bit no-pae</ca>
   <cs>antiX 4.9.146 kernel, 32 bit no-pae</cs>
   <da>antiX 4.9.146 kerne, 32 bit uden pae</da>
   ...
   <et>antiX 4.9.146 kernel, 32 bit no-pae</et>
   <eu>antiX 4.9.146 kernel, 32 bit no-pae</eu>
   <fa>antiX 4.9.146 kernel, 32 bit no-pae</fa>
   <fi>antiX 4.9.146 kernel, 32 bit no-pae</fi>
   <fr>Noyau antiX 4.9.146, 32 bit non-pae</fr>
   <he_IL>antiX 4.9.146 kernel, 32 bit no-pae</he_IL>
   <hi>antiX 4.9.146 kernel, 32 bit no-pae</hi>
   <hr>antiX 4.9.146 kernel, 32 bit no-pae</hr>
   <hu>antiX 4.9.146 kernel, 32 bit no-pae</hu>
   <id>antiX 4.9.146 kernel, 32 bit no-pae</id>
   <is>antiX 4.9.146 kernel, 32 bit no-pae</is>
   <it>Kernel antiX 4.9.146, 32 bit no-pae</it>
   <ja_JP>antiX 4.9.146 kernel, 32 bit no-pae</ja_JP>
   <ja>antiX 4.9.146 kernel, 32 bit no-pae</ja>
   <kk>antiX 4.9.146 kernel, 32 bit no-pae</kk>
   <ko>antiX 4.9.146 kernel, 32 bit no-pae</ko>
   <lt>antiX 4.9.146 kernel, 32 bit no-pae</lt>
   <mk>antiX 4.9.146 kernel, 32 bit no-pae</mk>
   <nb>antiX 4.9.146 kernel, 32 bit no-pae</nb>
