...
<description>
   ...
   <ko>antiX 4.9.200 kernel, 32 bit no-pae</ko>
   <lt>antiX 4.9.200 kernel, 32 bit no-pae</lt>
   <mk>antiX 4.9.200 kernel, 32 bit no-pae</mk>
   <mr>antiX 4.9.200 kernel, 32 bit no-pae</mr>
   <nb>antiX 4.9.200 kernel, 32 bit no-pae</nb>
...
linux-image-4.9.200-antix.1-486-smp
linux-headers-4.9.200-antix.1-486-smp
</install_package_names>


<postinstall>
rebuild_dkms_packages.sh linux-image-4.9.200-antix.1-486-smp
</postinstall>
