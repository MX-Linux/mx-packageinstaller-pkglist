...
<description>
   ...
   <fi>antiX 4.9.189 kernel, 32 bit no-pae</fi>
   <fr>Noyau antiX 4.9.189, 32 bit non-pae</fr>
   <he_IL>antiX 4.9.189 kernel, 32 bit no-pae</he_IL>
   <hi>antiX 4.9.189 kernel, 32 bit no-pae</hi>
   <hr>antiX 4.9.189 kernel, 32 bit no-pae</hr>
   ...
   <ko>antiX 4.9.189 kernel, 32 bit no-pae</ko>
   <lt>antiX 4.9.189 kernel, 32 bit no-pae</lt>
   <mk>antiX 4.9.189 kernel, 32 bit no-pae</mk>
   <mr>antiX 4.9.189 kernel, 32 bit no-pae</mr>
   <nb>antiX 4.9.189 kernel, 32 bit no-pae</nb>
   ...
   <zh_TW>antiX 4.9.189 kernel, 32 bit no-pae</zh_TW>
</description>
...
linux-image-4.9.189-antix.1-486-smp
linux-headers-4.9.189-antix.1-486-smp
</install_package_names>


<postinstall>
/usr/share/mx-packageinstaller-pkglist/rebuild_dkms_packages.sh linux-image-4.9.189-antix.1-486-smp
</postinstall>
