...
apt-get install linux-image-7.0.7-1-liquorix-amd64 linux-headers-7.0.7-1-liquorix-amd64 ${DKMS_PKGS[*]}
</preinstall>
...
<postinstall>
rebuild_dkms_packages.sh linux-image-7.0.7-1-liquorix-amd64
