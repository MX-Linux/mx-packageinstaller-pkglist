...
apt-get install linux-image-6.12.5-1-liquorix-amd64 linux-headers-6.12.5-1-liquorix-amd64 ${DKMS_PKGS[*]}
</preinstall>
...
<postinstall>
rebuild_dkms_packages.sh linux-image-6.12.5-1-liquorix-amd64
