...
<description>
   ...
   <bn>Serbian localisation of Firefox</bn>
   ...
   <el>Σερβικά για το Firefox</el>
   <en>Serbian localisation of Firefox</en>
   <es>Localización Serbio de Firefox</es>
   ...
   <nb>Serbisk lokaltilpassing av Firefox</nb>
   <nl>Servische lokalisatie van Firefox</nl>
   <pl>Serbska lokalizacja przeglądarki Firefox</pl>
   <pt_BR>Sérvio Localização para o Firefox</pt_BR>
   ...
   <sl>Srbske krajevne nastavitve za Firefox</sl>
   <sq>Përkthimi i Firefox-it në serbisht</sq>
   ...
   <vi>Serbian localisation of Firefox</vi>
