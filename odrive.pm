...
<description>
   ...
   <el>Πρόγραμμα συγχρονισμού αποθήκευσης cloud, πολλαπλών υπηρεσιών</el>
   ...
   <fi>Monipalvelullinen pilvitila- ja tiedostosynkronointiin tarkoitettu asiakasohjelma</fi>
   ...
   <hi>एकाधिक-सेवा युक्त क्लाउड संचय समकालीन साधन</hi>
   ...
   <nb>Synkroniseringsklient for skylagring, støtter flere tjenester</nb>
   <nl>Multi-service cloud-opslag synchronisatieclient</nl>
   <pl>Multi-service cloud storage sync client</pl>
   <pt_BR>Cliente multisserviços de sincronização de armazenamento em nuvem (cloud)</pt_BR>
   <pt>Cliente multi-serviços de sincronização de armazenamento em núvem</pt>
   ...
   <sq>Klient njëkohësimi depozitash në re, me shumë shërbime</sq>
   <sr>Multi-service cloud storage sync client</sr>
   <sv>Multi-service molnlagrings synk-klient</sv>
   <tr>Çoklu hizmet bulut depolama eşzamanlama istemcisi</tr>
