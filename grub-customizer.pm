...
<description>
   ...
   <el>Προσαρμογή στο μενού εκκίνησης του grub</el>
   ...
   <nb>tilpass oppstartsmenyen GRUB</nb>
   <nl>pas grub boot menu aan</nl>
   <pl>dostosowywuje menu rozruchowe grub</pl>
   <pt_BR>Personalizar o menu de inicialização do grub</pt_BR>
   ...
   <sq>përshtatni menunë grub të nisjes</sq>
   <sr>customize grub boot menu</sr>
   <sv>anpassa grub boot meny</sv>
   <tr>özelleştirilebilir grub önyükleme menüsü</tr>
