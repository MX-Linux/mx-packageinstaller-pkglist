...
<description>
   ...
   <nb>ekstra OpenGL-skjermbeskyttere</nb>
   ...
   <sq>ekrankursyes opengl ekstra</sq>
   <sr>extra opengl screensavers</sr>
   <sv>extra opengl skärmsläckare</sv>
   <tr>fazladan opengl ekran koruyucular</tr>
