...
<description>
   ...
   <bn>Portugese(PT) localisation of Thunderbird</bn>
   ...
   <el>Πορτογαλικά για το Thunderbird</el>
   ...
   <fi>Portugalilainen (PT) Thunderbird-kotoistus</fi>
   ...
   <vi>Portugese(PT) localisation of Thunderbird</vi>
