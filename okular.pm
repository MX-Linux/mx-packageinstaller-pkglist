...
<description>
   ...
   <bn>a universal document viewer -WARNING- pulls in elements of KDE</bn>
   ...
   <el>Γενικό πρόγραμμα προβολής εγγράφων-ΠΡΟΕΙΔΟΠΟΙΗΣΗ- τραβάει στοιχεία του KDE</el>
   ...
   <fi>yleismaailmallinen asiakirjakatselin -VAROITUS- asentaa sisään KDE-elementtejä</fi>
   ...
   <hi>सर्वत्र प्रलेख प्रदर्शक - चेतावनी - केडीई अनुखंड इंस्टॉल होंगे</hi>
   ...
   <nb>universell dokumenframviser – ADVARSEL – vil installere deler av KDE</nb>
   ...
   <pt_BR>Visualizador universal de documentos - AVISO - instala elementos do Ambiente de Trabalho KDE</pt_BR>
   ...
   <sq>një parës universal dokumentesh -KUJDES- fut brenda elementë të KDE-së</sq>
   ...
   <tr>evrensel bir belge görüntüleyici -UYARI- KDE öğelerini çeker</tr>
   <uk>універсальний переглядач документів -ПОПЕРЕДЖЕННЯ- потребує елементи KDE</uk>
   <vi>a universal document viewer -WARNING- pulls in elements of KDE</vi>
