...
<description>
   ...
   <bn>a software suite to create, edit, and compose bitmap images</bn>
   ...
   <el>Σουίτα λογισμικού για τη δημιουργία, επεξεργασία και σύνθεση εικόνων bitmap</el>
   ...
   <fi>ohjelma jonka avulla luot, muokkaat ja tuotat bitmap-muotoisia kuvia</fi>
   ...
   <hi>बिटमैप चित्र सृजन, संपादन व संयोजन हेतु सॉफ्टवेयर संग्रह</hi>
   ...
   <nb>programpakke for å lage, redigere og sette sammen punktgrafikk</nb>
   ...
   <pt_BR>Conjunto de programas para criar, editar, e compor imagens bitmap</pt_BR>
   ...
   <ru>Набор инструментов для создания, изменения и формирования растровых изображений</ru>
   ...
   <sq>një suitë software-i për krijim, përpunim, dhe hartim figurash bitmap</sq>
   ...
   <tr>bitmap resimler oluşturmak ve düzenlemek için bir yazılım takımı</tr>
   <uk>набір програм для створення, редагування та перетворення растрових зображень</uk>
   <vi>a software suite to create, edit, and compose bitmap images</vi>
