...
<preinstall>
wget https://download.opensuse.org/repositories/home:/gottcode/Debian_12/i386/ -O /tmp/gottcode.txt; FRED=$(grep kapow /tmp/gottcode.txt |cut -d\/ -f2 |cut -d\" -f1 |grep -v mirror |grep -v dbgsym); echo $FRED; rm /tmp/gottcode.txt
