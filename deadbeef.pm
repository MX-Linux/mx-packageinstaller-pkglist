...
<description>
   ...
   <de>Resourcenschonende Audiowiedergabe</de>
   ...
   <nb>enkel lydavspiller</nb>
   <nl>eenvoudige audio speler</nl>
   <pl>prosty odtwarzacz audio</pl>
   <pt_BR>Reprodutor de áudio simples</pt_BR>
   ...
   <sq>lojtës i thjeshtë audiosh</sq>
   <sr>simple audio player</sr>
   <sv>enkel ljudspelare</sv>
   <tr>basit ses çalar</tr>
