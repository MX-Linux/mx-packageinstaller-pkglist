...
<description>
   ...
   <fi>Kaikki-yhdessä-paikassa yhdistetty ääni- ja tekstikeskustelusovellus pelaajille</fi>
   <fr>Chat texte et voix tout-en-un pour les joueurs</fr>
   <he_IL>All-in-one voice and text chat for gamers</he_IL>
   <hi>ऑनलाइन खिलाड़ियों हेतु संयुक्त वाणी व लेख चैट</hi>
   ...
   <nb>tale- og tekstsnakking for gamere (alt-i-ett)</nb>
   <nl>Alles-in-een stem en tekst chat voor gamers</nl>
   <pl>kompleksowy czat głosowy i tekstowy dla graczy</pl>
   <pt_BR>Bate-papo de voz e texto tudo em um para jogadores</pt_BR>
   ...
   <sq>Fjalosje “all-in-one”, zë dhe tekst, për ata që luajnë lojëra</sq>
   <sr>All-in-one voice and text chat for gamers</sr>
   <sv>Allt-i-ett röst och textchatt för gamers</sv>
   <tr>Oyuncular için yazılı ve sesli söyleşi hepsi birarada</tr>
